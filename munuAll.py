class menuAll:
    ...
    def loadMenu(self):
        self.menu_map["beverage"] = ["原味奶茶", "抹茶奶茶", "巧克力奶茶", "珍珠奶茶", "奥利奥奶茶", "红豆奶茶",
                                     "抹茶红豆", "椰香奶茶", "原味奶绿", "茉莉奶绿", "草莓奶冻", "葡萄奶冻", "草莓奶昔",
                                     "水蜜桃奶昔", "芒果刨冰", "草莓刨冰", "哈密瓜刨冰", "柠檬冰沙", "奶香冰沙",
                                     "西瓜冰沙", "四季春茶", "茉莉绿茶", "龙井茶",
                                     "碧螺春", "蜂蜜柚子茶", "柠檬柚子茶", "红茶", "普洱茶", "铁观音", "冰乌龙",
                                     "标准美式", "卡布咖啡", "拿铁咖啡", "生椰拿铁",
                                     "厚乳拿铁", "草莓冰拿铁", "雪顶咖啡", "冰淇淋咖啡", "摩卡咖啡", "抹茶咖啡",
                                     "杨枝甘露", "多盲杨枝甘露", "草莓樱桃茶",
                                     "草莓酸奶", "一杯百香果", "蜜桃四季春", "生椰西瓜", "柠檬绿茶", "柠檬红茶",
                                     "一桶水果茶", "苹果汁", "柠檬汁", "西瓜汁",
                                     "橙汁", "葡萄汁", "芒果汁", "梨汁", "草莓汁", "樱桃汁", "桃子汁"]
